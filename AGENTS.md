...
3. If the operator explicitly asks for the GitHub checkout or the npm registry package rejects a Node.js version accepted by this repository, install directly from GitHub without keeping a checkout in the firmware project:
